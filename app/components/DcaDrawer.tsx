 ...
 *
 * 定投三 intent（create/toggle/delete）统一提交到 /me/dca 的 action——
 * 持仓详情页与基金详情页共用一个真相；从这两页发起时基金必已建档
 * （ensureFund / 持有在前），不会触发 me.dca 的「请先访问基金页」建档裂缝。
 *
 * zIndex 压到 900：面板内部会弹「新建定投」Modal（默认 zIndex 1000），
 * 抽屉不压它，弹窗才能浮在抽屉之上。
 */
