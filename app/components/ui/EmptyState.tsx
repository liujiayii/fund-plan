...
/**
 * Renders a branded empty-state layout with a primary message, optional hint, and optional action content.
 *
 * @param description - The primary empty-state message
 * @param hint - Optional secondary guidance
 * @param children - Optional action content
 */
