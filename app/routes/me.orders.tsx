...
import { getOrders, type OrderView } from '~/services/portfolio-service';
    ...
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      ...
      <Card title={`全部订单（${orders.length} 笔）`}>
            ...
            columns={[
              ...
              },
              {
                ...
                render: (v: number | null) =>
                  v === null ? '—' : (
                    <Text type="danger">{centsToYuan(v)} 元</Text>
                  ),
              },
            ]}
          />
        ...
        <Paragraph type="secondary" style={{ marginTop: 12, marginBottom: 0, fontSize: 12 }}>
          申购采用真实的<Text strong>内扣法</Text>：手续费从申购金额中扣除，
          剩余净额除以确认日净值得到份额。赎回按<Text strong>先进先出</Text>逐批计费。
        </Paragraph>
      </Card>
    </Space>
  );
